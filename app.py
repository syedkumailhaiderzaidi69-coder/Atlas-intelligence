...
with tab5:
    ...
    pdf.set_font("Arial", "B", 14)
    pdf.cell(0, 8, "Portfolio Strategy", ln=True)

    pdf.set_font("Arial", "", 11)
    pdf.cell(0, 8, f"Investment Goal: {investment_goal}", ln=True)
    pdf.cell(0, 8, f"Portfolio Budget: AED {portfolio_budget:,}", ln=True)
    ...
    pdf.multi_cell(
        0,
        7,
        "Generated by Atlas Intelligence - AI-powered Dubai real estate intelligence platform."
    )
